...
IPATH = -I. -I./3_BSW/MCAL/IODriver/DIO -I./SYSTEM/Drivers/CMSIS -I./SYSTEM/Drivers/Common -I./3_BSW/MCAL/IODriver/PORT
SRC = main.c 3_BSW/MCAL/IODriver/DIO/Dio.c ./SYSTEM/Startup/startup.c 3_BSW/MCAL/IODriver/PORT/Port.c
